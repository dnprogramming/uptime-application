...
export class GetApplicationsResponse extends jspb.Message {
  ...
  addApps(value?: ApplicationInformation, index?: number): ApplicationInformation;
...
export class ApplicationInformation extends jspb.Message {
  ...
  setLastupdated(value?: google_protobuf_timestamp_pb.Timestamp): ApplicationInformation;
  ...
  static toObject(includeInstance: boolean, msg: ApplicationInformation): ApplicationInformation.AsObject;
  static serializeBinaryToWriter(message: ApplicationInformation, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ApplicationInformation;
  static deserializeBinaryFromReader(message: ApplicationInformation, reader: jspb.BinaryReader): ApplicationInformation;
}
